...
# otam = {'ism':'Mamadaliyev Raxim', 't_yil':1981, 'shahri': 'Namangan shahar'}
# onam = {'ism':'Xoshimova Madina', 't_yil':1982, 'shahri': 'Namangan shahar'}
# ukam_1 = {'ism':'Ismoilov Javohir', 't_yil':2004, 'shahri': 'Namangan shahar'}
# ukam_2 = {'ism':'Ismoilov Bilolxon', 't_yil':2007, 'shahri': 'Namangan shahar'}
# ukam_3 = {'ism':'Ismoilov Abdulhay', 't_yil':2012, 'shahri': 'Namangan shahar'}

# print(f"Otamning ismi {otam['ism']}, {otam['shahri']}da, {otam['t_yil']}-yilda tug'ilgan")
# print(f"Onamning ismi {onam['ism']}, {onam['shahri']}da, {onam['t_yil']}-yilda tug'ilgan")
# print(f"Birinchi ukamning ismi {ukam_1['ism']}, {ukam_1['shahri']}da, {ukam_1['t_yil']}-yilda tug'ilgan")
# print(f"Ikkinchi ukamning ismi {ukam_2['ism']}, {ukam_2['shahri']}da, {ukam_2['t_yil']}-yilda tug'ilgan")
# print(f"Uchinchi ukamning ismi {ukam_3['ism']}, {ukam_3['shahri']}da, {ukam_3['t_yil']}-yilda tug'ilgan")
